...
directory = "dataset/Masked and Unmasked"
...
x_train, x_test, x_val = x_train_val[:train], x_train_val[train:test], x_train_val[test:val]
y_train, y_test, y_val = y_train_val[:train], y_train_val[train:test], y_train_val[test:val]
...
input = tf.keras.layers.Input((200, 200, 3))
...
input_1 = tf.keras.layers.Input((200, 200, 3))
input_2 = tf.keras.layers.Input((200, 200, 3))
