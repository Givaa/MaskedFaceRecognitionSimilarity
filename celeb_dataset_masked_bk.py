...
directory = "celeb_test/mask_unmask"
directoryModel = "model_save/mask_unmask/"
...
result = siamese.predict(path1="celeb_test/mask_unmask/unmasked/201210.jpg",
                path2="celeb_test/mask_unmask/masked/201210.jpg", visualize_result=True)
